"""ETL Component"""
from typing import NamedTuple  # Similar to dictionary, but supports both access from key-value and iteration.
from source_code.common.s3 import S3BucketConnector
import logging  # Package for logging.
import pandas as pd
from source_code.common.s3 import S3BucketConnector
from source_code.common.meta_process import MetaProcess
...
class ETL():
    """
    Reads the data from S3 bucket, transforms and writes the transformed to target
    """
