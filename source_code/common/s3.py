...
import os  # Read csv on AWS.
import boto3  # Python integration with AWS.
import logging  # Package for logging.
from io import StringIO, BytesIO
import pandas as pd
from source_code.common.constants import S3FileTypes
from source_code.common.custom_exceptions import WrongFormatException
...
class S3BucketConnector():
    ...
    def __init__(self, access_key: str, secret_key: str, endpoint_url: str, bucket: str):
        ...
        # Underline _s3 means that variable is protected, it should not be touched.
