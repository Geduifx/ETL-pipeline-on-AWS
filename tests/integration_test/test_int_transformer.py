...
from source_code.common.constants import MetaProcessFormat
from source_code.transformers.transformer import ETL, SourceConfig, TargetConfig

class IntTestETLMethods(unittest.TestCase):
    """
    Integration Testing the ETL class.
    """
    ...
    def setUp(self):
        ...
        self.s3_bucket_name_src = 'xetra3-int-test-src'
        self.s3_bucket_name_trg = 'xetra3-int-test-trg'
        ...
        conf_dict_trg = {
            ...
            'trg_key': 'report1/_daily_report1_',
